...
|[MarqueeView](https://github.com/sunfusheng/MarqueeView "MarqueeView")|功能强大的跑马灯|||
...
|名称|说明|来源|星星|
|------------|------------|------------|------------|
|[circular-progress-button](https://github.com/dmytrodanylyk/circular-progress-button "circular-progress-button")|进度条按钮|||
|[CircleProgressBar](https://github.com/dinuscxj/CircleProgressBar "CircleProgressBar")|进度条按钮（备选）|||
|[ColorArcProgressBar](https://github.com/Shinelw/ColorArcProgressBar "ColorArcProgressBar")|进度条按钮（备选2）|||
|[FloatingActionButton](https://github.com/Clans/FloatingActionButton "FloatingActionButton")|浮动事件按钮|||
|[circular-progress-button](https://github.com/dmytrodanylyk/circular-progress-button "circular-progress-button")|强大的进度按钮|||
|[优秀的button集合3.6万星星](https://github.com/wasabeef/awesome-android-ui/blob/master/pages/Button.md "优秀的button集合3.6万星星")||||
## 对话框
|名称|说明|来源|星星|
|------------|------------|------------|------------|
...
|[DateTimePicker](https://github.com/lany192/DateTimePicker "DateTimePicker")|轮滚日期时间选择器(基于安卓源码更改)|来自酷安的开源工具||
|[AndroidPicker](https://github.com/gzu-liyujiang/AndroidPicker "AndroidPicker")|多种选择器|||
|[Android-PickerView](https://github.com/Bigkoo/Android-PickerView "Android-PickerView")|轮滚选择器2019-08-09|||
...
|[Vorolay](https://github.com/Quatja/Vorolay "Vorolay")|类似石头铺路的效果|||
|[AndroidSwipeLayout](https://github.com/daimajia/AndroidSwipeLayout "AndroidSwipeLayout")|异常优秀的item滑动控件，可实现二楼效果，异常流畅，爱不释手|||
|[DynamicGrid](https://github.com/askerov/DynamicGrid "DynamicGrid")|类似桌面app图标的拖动效果|||
|[Android-ObservableScrollView](https://github.com/ksoichiro/Android-ObservableScrollView "Android-ObservableScrollView")|toolbar联动的滑动视图包括listview gridview等等|||
|[MaterialRecents](https://github.com/ZieIony/MaterialRecents "MaterialRecents")|类似最近任务的效果|||
